                                    ...
                                    <div class="d-flex align-items-end row">
                                        ...
                                        <div class="col-sm-5 text-center text-sm-left">
                                            <div class="card-body pb-0 px-0 px-md-4">
                                                <img src="/templates/admin/assets/img/illustrations/man-with-laptop-light.png"
                                            ...
                                            <div class="card-body">
                                                <div
                                                    ...
                                                    <div class="avatar flex-shrink-0">
                                                        <img src="/templates/admin/assets/img/icons/unicons/chart-success.png"
                                        ...
                                        <div class="card">
                                            <div class="card-body">
                                                <div
                                                    class="card-title d-flex align-items-start justify-content-between">
                                                    <div class="avatar flex-shrink-0">
                                                        <img src="/templates/admin/assets/img/icons/unicons/wallet-info.png"
                                        ...
                                        <div class="card">
                                            <div class="card-body">
                                                <div
                                                    class="card-title d-flex align-items-start justify-content-between">
                                                    <div class="avatar flex-shrink-0">
                                                        <img src="/templates/admin/assets/img/icons/unicons/paypal.png"
                                                            alt="Credit Card" class="rounded" />
                                                    </div>
                                                    <div class="dropdown">
                                        ...
                                        <div class="card">
                                            <div class="card-body">
                                                <div
                                                    class="card-title d-flex align-items-start justify-content-between">
                                                    <div class="avatar flex-shrink-0">
                                                        <img src="/templates/admin/assets/img/icons/unicons/cc-primary.png"
                                                            alt="Credit Card" class="rounded" />
                                                    </div>
                                                    <div class="dropdown">
